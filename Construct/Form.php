...
class Form
{
    ...
    {
        $tokenField = new \Construct\Form\Field\Antispam();
     ...
     * construct tries to detect environment automatically based on current controller. You can set manually the right mode if needed.
     * @param $environment
     */
    ...
    {
        $tokenField = new \Construct\Form\Field\Csrf();
     ...
     * @param \Construct\Form\Fieldset | string $fieldset
     */
    public function addFieldset($fieldset)
    {
        if (is_string($fieldset)) {
            $fieldset = new \Construct\Form\Fieldset($fieldset);
        }
     ...
     */
    public function addField(\Construct\Form\Field $field)
    {
     ...
     *
     * Set post method.
     * @param string $method Use \Construct\Form::METHOD_POST or \Construct\Form::METHOD_GET
     * @throws Exception
     */
     ...
     */
    public function render(\Construct\View $view = null)
    {
        if (!$view) {
