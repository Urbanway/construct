...
class Db
{
    ...
    public function getConnection()
    {
        ...
        if (empty($dbConfig)) {
            throw new \Construct\Exception\Db("Can't connect to database. No connection config found or \\Construct\\Db::disconnect() has been used.");
        }
        ...
        try {
            ...
            throw new \Construct\Exception($e->getMessage());
    ...
    public function fetchValue($sql, $params = array())
    {
        try {
            ...
            throw new \Construct\Exception\Db($e->getMessage(), $e->getCode(), $e);
        }
    }
