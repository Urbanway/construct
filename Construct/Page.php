...
class Page
{
     ...
     *
     * @param \Construct\Controller $controller
     */
    public function init(\Construct\Controller $controller)
    {
    ...
    public function getChildren($from = null, $till = null, $orderBy = 'pageOrder', $direction = 'ASC')
    {
        switch ($orderBy) {
            ...
            case 'deletedAt':
                ...
                break;
            default:
                throw new \Construct\Exception("getChildren can't accept " . esc($orderBy) . " as an order field.");
        }
