...
class Request
{
     ...
     *
     * @throws \Construct\Exception is thrown if POST method was not used.
     */
    public function mustBePost()
    {
        if (!$this->isPost()) {
            throw new \Construct\Exception('POST method required.');
        }
    }
    ...
    /**
     * @private
     * for internal construct uses only
     */
