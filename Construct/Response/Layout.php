 ...
 *
 */
class Layout extends \Construct\Response
{
    ...
    public function execute()
    {
        ...
        } elseif (strpos($layout, '/') !== false) { //impresspages path. Eg. Construct/Internal/xxx.php
            $viewFile = $layout;
        ...
        $response = new \Construct\Response($content, $this->getHeaders(), $this->getStatusCode());
    ...
    {
        if (ipRoute()->isAdmin()) {
            $this->layout = 'Construct/Internal/Admin/view/layout.php';
        } elseif (\Construct\Internal\Admin\Model::isSafeMode()) {
            $this->layout = 'Construct/Internal/Admin/view/safeModeLayout.php';
        } else {
