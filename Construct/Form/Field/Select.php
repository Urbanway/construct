...
class Select extends \Construct\Form\Field
{
...
';
     ...
     * @see Construct\Form\Field.Field::getValidationAttributesStr()
     * @param string $doctype
     * @return string
     */
    public function getValidationAttributesStr($doctype)
    {
        ...
        $html5Important = ($doctype == \Construct\Response\Layout::DOCTYPE_HTML5 && $this->getAttribute(
                'size'
