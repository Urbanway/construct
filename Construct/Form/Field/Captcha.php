...
class Captcha extends Field
{
    ...
    public function __construct($options = array())
    {
        $this->captchaInit = array(
            ...
            'TTF_folder' => ipFile('Construct/Lib/HnCaptcha/fonts/'),
    ...
    {
        $captcha = new \Construct\Lib\HnCaptcha\HnCaptcha($this->captchaInit, true);
    ...
    public function validate($values, $valueKey, $environment)
    {
        if ($environment == \Construct\Form::ENVIRONMENT_ADMIN) {
            $errorText = __('The characters you entered didn\'t match', 'Construct-admin', false);
        } else {
            $errorText = __('The characters you entered didn\'t match', 'Construct', false);
        }
