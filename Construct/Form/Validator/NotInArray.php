...
class NotInArray extends \Construct\Form\Validator
{
    ...
    public function getError($values, $valueKey, $environment)
    {
        ...
        if (in_array($values[$valueKey], $this->data)) {
            ...
            if ($environment == \Construct\Form::ENVIRONMENT_ADMIN) {
                $errorText = __('The value can\'t be one of:', 'Construct-admin');
            } else {
                $errorText = __('The value can\'t be one of:', 'Construct');
            }
