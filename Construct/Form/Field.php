...
abstract class Field
{
     ...
     *
     * @param string $doctype \Construct\View doctype constant
     ...
     * Get validators
     *
     * @return \Construct\Form\Validator[]
     */
    ...
    public function isRequired()
    {
        ...
        foreach ($validators as $validator) {
            if (get_class($validator) == 'Construct\Form\Validator\Required') {
                return true;
            }
        }
     ...
     *
     * Available validators are located at Construct/Form/Field/Validator folder.
    ...
    public function addValidator($validator)
    {
        ...
        if (empty($validator)) {
            throw new \Construct\Exception('Empty validator');
        }

        if (is_string($validator[0])) {
            if (preg_match('/^[a-z0-9]+$/i', $validator[0])) {
                $validatorClass = '\\Construct\\Form\\Validator\\' . $validator[0];
            } else {
            ...
            if (count($validator) >= 3) {
                ...
                throw new \Construct\Exception('Incorrect validator');
            }
    ...
    /**
     * Set field layout. Use constants \Construct\Form\Field::LAYOUT_DEFAULT, \Construct\Form\Field::LAYOUT_BLANK, \Construct\Form\Field::LAYOUT_NO_LABEL,
     *
     * @param string $layout.
     */
