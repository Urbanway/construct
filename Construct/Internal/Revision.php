...
class Revision
{
    ...
    public static function publishRevision($revisionId)
    {
        ...
        if (!$wasUpdated) {
            throw new \Construct\Exception\Db("Can't publish page #" . esc($revision['pageId']) . " revision #" . esc(
                $revisionId
            ) . "");
        }
    ...
    public static function duplicateRevision($oldRevisionId, $pageId = null, $published = null)
    {
        ...
        if (!$oldRevision) {
            throw new \Construct\Exception\Revision("Can't find old revision: " . esc($oldRevisionId));
        }
