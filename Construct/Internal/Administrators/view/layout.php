<div ng-app="Administrators" ng-controller="ipAdministratorsController" class="ipModuleAdministrators ipsModuleAdministrators">
    ...
    <div class="page-header">
        <h1><?php _e('Administrator profile', 'Construct-admin'); ?></h1>
    </div>
    <div ng-show="activeAdministrator" ng-cloak>
        ...
        <div ng-show="!editMode">
            ...
            <div class="row">
                <div class="col-md-5">
                    <h3><?php _e('Username', 'Construct-admin'); ?></h3>
                    <p>{{activeAdministrator.username}}</p>
                </div>
                <div class="col-md-7">
                    <h3><?php _e('Email', 'Construct-admin'); ?></h3>
                    <p>{{activeAdministrator.email}}</p>
                </div>
            </div>

            <h2><?php _e('Permissions', 'Construct-admin'); ?></h2>
    ...
    <?php echo ipView('Construct/Internal/Administrators/view/addModal.php', array('createForm' => $createForm))->render(); ?>
    <?php echo ipView('Construct/Internal/Administrators/view/updateModal.php', array('updateForm' => $updateForm))->render(); ?>
    <?php echo ipView('Construct/Internal/Administrators/view/deleteModal.php', array('updateForm' => $updateForm))->render(); ?>
</div>
