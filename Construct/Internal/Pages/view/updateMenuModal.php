        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="ipsDeleteConfirmation hidden">
                    ...
                    <button class="btn btn-danger ipsDeleteProceed" role="button"><?php _e('Delete', 'Construct-admin'); ?><i class="fa fa-fw fa-trash-o"></i></button>
                    <button class="btn btn-default ipsDeleteCancel" role="button"><?php _e('Cancel', 'Construct-admin'); ?></button>
                </div>
            ...
            <div class="modal-footer ipsModalActions">
                ...
                <button class="btn btn-danger ipsDelete" type="button" role="button"><?php _e('Delete', 'Construct-admin'); ?><i class="fa fa-fw fa-trash-o"></i></button>
