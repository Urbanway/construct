...
class ConfigModel
{
    ...
    public function getThemeConfigForm($name)
    {
        ...
        $generalFieldset->setLabel(__('General options', 'Construct-admin'));
    ...
    {
        $fieldset = new \Construct\Form\Fieldset();
        ...
        foreach ($options as $option) {
            ...
            switch ($option['type']) {
                ...
                case 'Checkbox':
                    ...
                    break;
                default:
                    $class = 'Construct\\Form\\Field\\' . $option['type'];
    ...
    protected function hasPermission()
    {
        ...
        if (!\Construct\Internal\Admin\Backend::loggedIn()) {
            return false;
        }
