...
class AdminController extends \Construct\Controller
{
    ...
    public function index()
    {
        ...
        ipAddJs('Construct/Internal/Design/assets/options.js');
        ipAddJs('Construct/Internal/Design/assets/market.js');
        ipAddJs('Construct/Internal/Design/assets/design.js');
        ipAddJs('Construct/Internal/Design/assets/pluginInstall.js');
        ...
        $installedPlugins = \Construct\Internal\Plugins\Service::getActivePluginNames();
        $notInstalledPlugins = [];
        ...
        $data = array(
            ...
            'contentManagementText' => __('Manage content', 'Construct-admin', false)
        );
    ...
    public function installPlugin()
    {
        ...
        try {
            ...
            $_SESSION['module']['design']['pluginNote'] = __('Plugin has been successfully installed.', 'Construct-admin');
    ...
    public function installTheme()
    {
        ...
        if (empty($themeName)) {
            throw new \Construct\Exception('Invalid arguments.');
        }
    ...
    public function updateConfig()
    {
        ...
        foreach ($options as $option) {
            ...
            switch ($option['type']) {
                case 'checkbox':
                    /**
                     * @var \Construct\Form\Field\Checkbox $field
                     */
        ...
        \Construct\Internal\Core\Service::invalidateAssetCache();
    ...
    public function realTimeLess()
    {
        ...
        if (empty($file)) {
            throw new \Construct\Exception("Required parameter missing");
        }
        ...
        return new \Construct\Response($css, 'Content-type: text/css');
    }
}
