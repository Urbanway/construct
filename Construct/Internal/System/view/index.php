<div class="ipModuleSystem" ng-app="System" ng-controller="ipTrash">
    ...
    <?php if ($changedUrl) { ?>
        ...
        <a href="<?php echo ipActionUrl(array('aa' => 'System.updateLinks')) ?>" class="ipsUpdateLinks btn btn-primary"><?php _e('Update links', 'Construct-admin'); ?></a>
    <?php } ?>
    ...
    <?php if ($migrationsAvailable) { ?>
        ...
        <a class="btn btn-primary ipsStartMigration" href="<?php echo $migrationsUrl ?>"><?php _e('Update', 'Construct-admin') ?></a>
    <?php } ?>
