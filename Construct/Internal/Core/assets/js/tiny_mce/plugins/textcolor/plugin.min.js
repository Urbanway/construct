tinymce.PluginManager.add("textcolor", function (a) {
    ...
    function d() {
        function b(a, b) {
            var c = "transparent" == a;
            return '<td class="mce-grid-cell' + (c ? " mce-colorbttn-trans" : "") + '"><div id="' + n + "-" + o++ + '" data-mce-color="' + (a ? a : "") + '" role="option" tabIndex="-1" style="' + (a ? "background-color: " + a : "") + '" title="' + tinymce.translate(b) + '">' + (c ? "&#215;" : "") + "</div></td>"
        }
        ...
        if (a.settings.color_picker_callback) {
            for (f += '<tr><td colspan="' + i + '" class="mce-custom-color-bttn"><div id="' + n + '-c" class="mce-widget mce-bttn mce-bttn-small mce-bttn-flat" role="button" tabindex="-1" aria-labelledby="' + n + '-c" style="width: 100%"><button type="button" role="presentation" tabindex="-1">' + tinymce.translate("Custom...") + "</button></div></td></tr>", f += "<tr>", h = 0; i > h; h++)f += b("", "Custom color");
            f += "</tr>"
        }
    ...
    function g(c) {
        ...
        var h, j = this.parent();
        if (tinymce.DOM.getParent(c.target, ".mce-custom-color-bttn") && (j.hidePanel(), a.settings.color_picker_callback.call(a, function (a) {
