/*!
 * construct form initialization function
 *
 */
    ...
    ipModuleFormPublic = new function () {
        this.init = function () {
            ...
            if ($('.ipsModuleFormPublic .ipsFileContainer').length && (typeof(plupload) === "undefined")) {
                $('body').append($('<script type="text/javascript" src="' + ipFileUrl('Construct/Internal/Core/assets/ipCore/plupload/plupload.full.js') + '"></script>'));
            }


            if (($('.ipsModuleFormPublic .type-color').length || $('.ipsModuleFormAdmin .type-color').length) && !$.fn.colorpicker) {
                $('body').append('<script type="text/javascript" src="' + ipFileUrl('Construct/Internal/Core/assets/js/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js') + '"></script>');
                $('head').append('<link rel="stylesheet" href="' + ipFileUrl('Construct/Internal/Core/assets/js/bootstrap-colorpicker/css/bootstrap-colorpicker.css') + '" type="text/css" />');
            }
            ...
            if (($('.ipsModuleFormPublic .type-richText').length || $('.ipsModuleFormPublic .type-richTextLang').length) && (typeof(ipTinyMceConfigPublic) === "undefined")) {
                $('body').append('<script type="text/javascript" src="' + ipFileUrl('Construct/Internal/Core/assets/js/tiny_mce/jquery.tinymce.min.js') + '"></script>');
                $('body').append('<script type="text/javascript" src="' + ipFileUrl('Construct/Internal/Core/assets/js/tiny_mce/tinymce.min.js') + '"></script>');
                $('body').append('<script type="text/javascript" src="' + ipFileUrl('Construct/Internal/Core/assets/tinymce/defaultPublic.js') + '"></script>');
            }
