...
class SiteController extends \Construct\Controller
{
    ...
    public function upload()
    {
        ...
        } catch (\Construct\Exception\Repository\Upload\ForbiddenFileExtension $e) {
            // Return JSON-RPC response
            $message = __('Forbidden file type.', 'Construct-admin');
            ipLog()->info(
        ...
        } catch (\Construct\Exception\Repository\Upload $e) {
            ipLog()->error('Repository.fileUploadError', array('plugin' => 'Repository', 'exception' => $e));
            $message = __('Can\'t store uploaded file. Please check server configuration.', 'Construct-admin');
        ...
        return new \Construct\Response\Json($answerArray);
