...
namespace Construct\Internal\Repository\Transform;

abstract class Image extends \Construct\Internal\Repository\Transform
{
     ...
     * @param $imageFile
     * @return resource
     * @throws \Construct\Exception\Repository\Transform
     */
    protected function createImageImage($imageFile)
    {
        ...
        switch ($mime) {
            ...
            case IMAGETYPE_PNG:
                ...
                break;
            default:
                throw new \Construct\Exception\Repository\Transform("Incompatible type. Type detected: " . esc(
                    $mime
                ), array('mime' => $mime));
        }
    ...
    protected function createEmptyImage($width, $height)
    {
        ...
        \Construct\Internal\System\Helper\SystemInfo::allocateMemory($width * $height * (2.2 + ($trueColor * 3)));
    ...
    protected function getMemoryNeeded($imageFile)
    {
        ...
        $success = \Construct\Internal\System\Helper\SystemInfo::allocateMemory($memoryNeeded);
    ...
    protected function saveJpeg($image, $fileName, $quality)
    {
        ...
        if (!imagejpeg($image, $fileName, (int)$quality)) {
            throw new \Construct\Exception\Repository\Transform("Can't write to file: " . esc(
                $fileName
    ...
    protected function getMimeType($imageFile)
    {
        ...
        if (isset($imageInfo[2])) {
            ...
            throw new \Construct\Exception\Repository\Transform("Incompatible type.", array('filename' => $imageFile));
        }
