            ...
            return this.each(function () {
                ...
                if (!data) {
                    ...
                    var uploaderConfig = {
                        ...
                        chunk_size: '1mb',
                        url: ip.baseUrl, //website root (available globally in construct environment)
                        multipart_params: {
                        ...
                        flash_swf_url: ipFileUrl('Construct/Internal/Core/assets/ipCore/plupload/plupload.flash.swf'),
                        silverlight_xap_url: ipFileUrl('Construct/Internal/Core/assets/ipCore/plupload/plupload.silverlight.xap'),
