...
<div class="ipsUploadProgressContainer  <?php echo $allowUpload ? '' : 'hidden' ?>">
    ...
    <div class="ipsBrowseButtonWrapper _browseButtonWrapper">
        ...
        <a href="#" class="bttn bttn-primary" id="ipsModuleRepositoryUploadButton"><?php _e('Add new', 'Construct-admin'); ?></a>
    </div>
    <div class="_browseButtonWrapper">
        ...
        <a href="#ipsModuleRepositoryTabBuy" class="bttn bttn-warning" id="ipsModuleRepositoryBuyButton"><?php _e('Buy images', 'Construct-admin'); ?></a>
    </div>
</div>
