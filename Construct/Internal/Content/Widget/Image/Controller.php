 ...
 *
 */
namespace Construct\Internal\Content\Widget\Image;
...
class Controller extends \Construct\WidgetController
{
    ...
    {
        return __('Image', 'Construct-admin', false);
    }
            ...
            switch ($postData['method']) {
                ...
                case 'resize':
                    ...
                    if (!isset($postData['width']) || !$postData['height']) {
                        ...
                        throw new \Construct\Exception("Missing required data");
                    }
                ...
                case 'update':
                    ...
                    if (isset($postData['fileName']) && is_file(ipFile('file/repository/' . $postData['fileName']))) {
                        ...
                        if (isset($currentData['imageOriginal']) && $currentData['imageOriginal']) {
                            \Construct\Internal\Repository\Model::unbindFile(
    ...
    private function _deleteImage($data, $widgetId)
    {
        ...
        if (isset($data['imageOriginal']) && $data['imageOriginal']) {
            \Construct\Internal\Repository\Model::unbindFile($data['imageOriginal'], 'Content', $widgetId);
        }
    }
    ...
    public function duplicate($oldId, $newId, $data)
    {
        ...
        if (isset($data['imageOriginal']) && $data['imageOriginal']) {
            \Construct\Internal\Repository\Model::bindFile($data['imageOriginal'], 'Content', $newId);
        }
        return $data;
    }
