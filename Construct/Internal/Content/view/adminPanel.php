<?php
/**
 * @var Construct\WidgetController[] $widgets
 */
?>
 ...
 widget search functionality works but no need to have it now
            ...
            <div class="ipsAdminPanelWidgetsSearch clearfix">
                <div class="ipaControls">
                    ...
                    <input type="text" class="ipAdminInput ipaInput ipsInput" value="<?php _e('Search widgets', 'Construct-admin') ?>" />
...
*/ ?>
        ...
        <?php if(!$manageableRevision){ ?>
            <div class="_disable">
                <p>
                    <?php echo __('This is a preview of older revision, created at', 'Construct-admin'); ?> <?php echo ipFormatDateTime(strtotime($currentRevision['createdAt']), 'Construct-admin') ?>
                    <a href="#" class="ipsContentPublish"><?php _e('Publish this revision', 'Construct-admin'); ?></a>
                    <a href="#" class="ipsContentSave"><?php _e('Duplicate and edit this revision', 'Construct-admin'); ?></a>
                </p>
            </div>
        <?php } ?>
