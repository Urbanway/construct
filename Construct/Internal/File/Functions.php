...
namespace Construct\Internal\File;
...
class Functions
{
    ...
    {
        $fileName = \Construct\Internal\Text\Transliteration::transform($fileName);
    ...
    {
        $newBasename = \Construct\Internal\File\Functions::genUnoccupiedName($relativePath, $destinationDir);
