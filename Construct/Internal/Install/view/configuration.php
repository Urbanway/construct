...
<form role="form" class="ipsConfigurationForm">
    ...
    <div class="checkbox">
        <label>
            <input type="checkbox" id="ipsConfigSupport" name="configSupport"<?php if ($config['support']) { echo ' checked="checked"'; } ?>> <?php _e('Get construct support and updates', 'Install'); ?>
        </label>
    </div>
    <p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><?php _e('construct Terms of Use', 'Install'); ?></h4>
                </div>
                <div class="modal-body" style="max-height: 270px; overflow: auto;">
                    ...
                    <p>Your website is configured to share usage statistics with construct to help us make the software better in the future. We may periodically send notifications or promotional materials related to your website, our products and services to the administrators of the website.</p>
