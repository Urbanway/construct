...
';
    ...
    {
        if (\Construct\Internal\System\Helper\SystemInfo::getMemoryLimitAsMb() < 100 && \Construct\Internal\System\Helper\SystemInfo::getMemoryLimitAsMb() != -1) {
            return 'warning';
        }
        return 'success';
    }
    ...
    public static function checkFolderConstruct()
    {
        if (!Helper::isDirectoryWritable(ipConfig()->get('baseDir') . '/Construct/')) {
            return 'warning';
        }
        return 'success';
    }
    ...
    public static function setUsageStatistics($action, $data)
    {
        $usageStatistics = array(
            ...
            'languages' => [],
            'pages' => [],
            'locale' => isset($_SESSION['installationLanguage']) ? $_SESSION['installationLanguage'] : \Construct\Internal\Install\Helper::$defaultLanguageCode,
