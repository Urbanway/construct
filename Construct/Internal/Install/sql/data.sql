...
('Config', 'Config.reservedDirs', '["file","install","Construct","Plugin","update","Theme","index.php","admin","admin.php"]'),
...
('Construct', 'version', '"5.0.3"'),  /* //CHANGE_ON_VERSION_UPDATE */
('Construct', 'dbVersion', '101'), /* //CHANGE_ON_VERSION_UPDATE */
('Construct', 'theme', '"Air"'),
('Construct', 'cachedBaseUrl', ''),
('Construct', 'lastSystemMessageSent', ''),
('Construct', 'lastSystemMessageShown', ''),
('Construct', 'cacheVersion', '1'),
('Construct', 'websiteId', '"123456789"'),
('Construct', 'getconstructSupport', '"0"');
