...
class Helper
{
    ...
    public static function pluginPropertiesForm($pluginName)
    {
        ...
        $field = new \Construct\Form\Field\Submit(array(
            'value' => __('Save', 'Construct-admin'),
        ));
    ...
    public static function getOptionsForm($pluginName, $form, $options)
    {
        foreach ($options as $option) {
            ...
            if (class_exists($className)) {
                ...
                $className = 'Construct\\Form\\Field\\' . $option['type'];
                if (class_exists($className)) {
                    $newField = new $className($option);
                }
            }
            ...
            if (!empty($option['name'])) {
                ...
                if ($newField instanceof \Construct\Form\FieldLang) {
                    $value = [];
