...
use Construct\Internal\InlineValue\Entity\Scope as Scope;
...
class AdminController extends \Construct\Controller
{
    ...
    public function getManagementPopupImage()
    {
        ...
        $scopePageTitle = __('Current page and sub-pages', 'Construct-admin', false);
        $scopeParentPageTitle = __('Page "[[page]]" and all sub-pages', 'Construct-admin', false);
        $scopeLanguageTitle = __('All [[language]] pages', 'Construct-admin', false);
        $scopeAllPagesTitle = __('All pages', 'Construct-admin', false);
    ...
    public function saveLogo()
    {
        ...
        if (isset($_POST['newImage']) && is_file(ipFile('file/repository/' . $_POST['newImage']))) {
            ...
            \Construct\Internal\Repository\Model::bindFile(
                $_POST['newImage'],
                'developer/inline_management',
                1
            ); //1 means logo
     ...
     * @param string $key
     * @param \Construct\Internal\InlineValue\Entity\Scope $scope
     */
