...
namespace Construct\Internal\InlineManagement\Entity;
...
class Logo
{
    ...
    public function __construct($data, $defaultLogo = null)
    {
        ...
        if (!empty($data['imageOrig']) && file_exists(ipFile('file/repository/' . $data['imageOrig']))) {
            ...
            if (isset($data['x1']) && isset($data['y1']) && isset($data['x2']) && isset($data['y2'])) {
                ...
                $requestedName = \Construct\Internal\Text\Specialchars::url(ipGetOptionLang('Config.websiteTitle'));
    ...
    public function getValueStr()
    {
        ...
        return json_encode(\Construct\Internal\Text\Utf8::checkEncoding($data));
    }
