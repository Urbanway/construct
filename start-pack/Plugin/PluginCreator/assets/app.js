...
function Add(btn) {
    ...
    cloned.attr('id',"template" + _counter );
     cloned.find('#slug').val('');
      cloned.find('#name').val('');
     cloned.find('#name').focus();
	  cloned.find('#slug').slugify(cloned.find('#name')); // Type as you slug
  /*   cloned.find('#name').attr('name','name_' + _counter);
     cloned.find('#slug').attr('name','slug_' + _counter);
     cloned.find('#type').attr('name','type_' + _counter);
     cloned.find('#required').attr('name','required_' + _counter);*/
